...
namespace ASPnetControls
{
    ...
    {
        /*
<a title=" Back to Page 1" class="ebtn" style="cursor: pointer;" href="javascript:__doPostBack('ctl00$MainContent$pager','1')">이전</a>
<a class="selected" style="cursor: pointer;"><span>11</span></a>
<a title="Show Result 111  120 of 1107" class="num" style="cursor: pointer;" href="javascript:__doPostBack('ctl00$MainContent$pager','12')"><span>12 </span></a>
<a title="Show Result 121  130 of 1107" class="num" style="cursor: pointer;" href="javascript:__doPostBack('ctl00$MainContent$pager','13')"><span>13 </span></a>
<a title="Show Result 131  140 of 1107" class="num" style="cursor: pointer;" href="javascript:__doPostBack('ctl00$MainContent$pager','14')"><span>14 </span></a>
<a title="Show Result 141  150 of 1107" class="num" style="cursor: pointer;" href="javascript:__doPostBack('ctl00$MainContent$pager','15')"><span>15 </span></a>
<a title="Show Result 151  160 of 1107" class="num" style="cursor: pointer;" href="javascript:__doPostBack('ctl00$MainContent$pager','16')"><span>16 </span></a>
<a title="Show Result 161  170 of 1107" class="num" style="cursor: pointer;" href="javascript:__doPostBack('ctl00$MainContent$pager','17')"><span>17 </span></a>
<a title="Show Result 171  180 of 1107" class="num" style="cursor: pointer;" href="javascript:__doPostBack('ctl00$MainContent$pager','18')"><span>18 </span></a>
<a title="Show Result 181  190 of 1107" class="num" style="cursor: pointer;" href="javascript:__doPostBack('ctl00$MainContent$pager','19')"><span>19 </span></a>
<a title="Show Result 191  200 of 1107" class="num" style="cursor: pointer;" href="javascript:__doPostBack('ctl00$MainContent$pager','20')"><span>20 </span></a>
<a title=" Next to Page 21" class="ebtn" style="cursor: pointer;" href="javascript:__doPostBack('ctl00$MainContent$pager','21')">다음</a>
        */
       ...
       [Browsable(false)]
        ...
        /// </summary>
        private int _maxSmartShortCutCount = 10;
        [Category("Behavioural")]
        ...
        /// </summary>
        private int _notCompactedPageCount = 10;
        [Category("Behavioural")]
        ...
        /// </summary>
        private bool _generateHiddenHyperlinks = true;
        [Category("Behavioural")]
        ...
        {
            string templateCell = "<a style='cursor: pointer; position: relative; right: -4px;' class='btn-first' href=\"{0}\" title=\"" + " " + BackToFirstClause + " " + "\" ></a>\r\n";
            return String.Format(templateCell, Page.ClientScript.GetPostBackClientHyperlink(this, "1"));
        }

        private string RenderLast()

        {  int gapValue = (CurrentIndex % 10); // / 2;
            int leftBand = (CurrentIndex - gapValue) + 1; //-gapValue 
            int rightBand = leftBand + 9;
            if (CurrentIndex == 10)
                leftBand = 1;
            if (PageCount - 10 >= (leftBand) && PageCount > 10)
            {
                string templateCell = "<a style= 'cursor: pointer; left: -4px; position: relative;'  class='btn-last' href=\"{0}\" title=\"" + " " + GoToLastClause + " " + "\"></a>\r\n";
            ...
            //else
            //{
            //    string templateCell = "<a style= 'cursor: pointer; left: 10px; position: relative;'  class='btn-last' href=\"{0}\" title=\"" + " " + GoToLastClause + " " + "\"></a>\r\n";
            //    return String.Format(templateCell, Page.ClientScript.GetPostBackClientHyperlink(this, PageCount.ToString()));
            //}
        }
        private string RenderBack()
        {
                ...
                if (CurrentIndex > 10)
                {
                    string templateCell = "<a href=\"{0}\" title=\"" + " " + BackToPageClause + " " + (leftBand - 10).ToString() + "\"><img src=\"/common/images/btn/paging2.png\" alt=\"\" title=\"이전\" /></a>\r\n";
                    return String.Format(templateCell, Page.ClientScript.GetPostBackClientHyperlink(this, (leftBand - 10).ToString()));
                }
                return "";
        ...
        private string RenderNext()
        {
            ...
            if (PageCount -10 >= (leftBand) && PageCount > 10)
            {
                ...
                string templateCell = "<a href=\"{0}\" title=\"" + " " + NextToPageClause + " " + (leftBand + 10).ToString() + "\"><img src=\"/common/images/btn/paging3.png\" alt=\"\" title=\"다음\" /></a>\r\n";
                return String.Format(templateCell, Page.ClientScript.GetPostBackClientHyperlink(this, (leftBand + 10).ToString()));
            }
            else {
                return "";
        ...
        private string RenderCurrent(int pageNumber)
        {
            return "<a style='cursor:pointer;' class='on'>" + CurrentIndex.ToString() + "</a>\r\n";
        }

        private string RenderOther(int pageNumber)
        {
            string templateCell = "<a style='cursor:pointer;' class='' href=\"{0}\" " + GetAlternativeText(pageNumber) + " >" + pageNumber.ToString() + "</a>\r\n";
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            else if (CurrentIndex > NormalModePageCount)
            {
                ...
                if (gapValue == 0)
                {
                    gapValue = CurrentIndex;
                    leftBand = gapValue - 9;
                    rightBand = gapValue;
                    CurrentIndex = rightBand;


                }
                else
                {
                    leftBand = (CurrentIndex - gapValue) + 1; //-gapValue 
                    rightBand = leftBand + 9;
                    //CurrentIndex = leftBand;  이걸 왜넣지..? pdh 2013-11-28 10이상 페이지에서 14를 눌러도 11이 클릭된거로 나옴 이거 왜있는지모르겟지만 삭제.
                }
