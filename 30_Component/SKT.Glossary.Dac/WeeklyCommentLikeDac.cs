...
namespace SKT.Glossary.Dac
{
	...
	/// 작성자 : miksystem.com
	/// </summary>
	public sealed class WeeklyCommentLikeDac
	{
		private const string connectionStringName = "ConnGlossary";

		public WeeklyCommentLikeDac() {}

		/// <summary>
		/// Inserts a record into the tb_WeeklyCommentLike table.
		/// </summary>
		/// <returns></returns>
		public int WeeklyCommentLikeInsert(WeeklyCommentLikeType weeklyCommentLikeType)
		{
		...
		public WeeklyCommentLikeType WeeklyCommentLikeSelect(Int64 iD)
		{
			Database db = DatabaseFactory.CreateDatabase(connectionStringName);
			DbCommand dbCommand = db.GetStoredProcCommand("up_WeeklyCommentLike_Select");

			db.AddInParameter(dbCommand, "ID", DbType.Int64, iD);

			WeeklyCommentLikeType weeklyCommentLikeType = null;
		...
		/// </summary>
		public List<WeeklyCommentLikeType> WeeklyCommentLikeSelectAll()
		{
			List<WeeklyCommentLikeType> listWeeklyCommentLikeType = new List<WeeklyCommentLikeType>();
			Database db = DatabaseFactory.CreateDatabase(connectionStringName);
			DbCommand dbCommand = db.GetStoredProcCommand("up_WeeklyCommentLike_SelectAll");
			...
			using (DataSet ds = db.ExecuteDataSet(dbCommand))
			{
			    if (ds != null && ds.Tables.Count > 0)
			    {
			        ...
			        {
			            WeeklyCommentLikeType weeklyCommentLikeType = GetWeeklyCommentLikeTypeMapData(dr);
		...
		/// </summary>
		private WeeklyCommentLikeType GetWeeklyCommentLikeTypeMapData(DataRow dr)
		{
			WeeklyCommentLikeType weeklyCommentLikeType = new WeeklyCommentLikeType();
