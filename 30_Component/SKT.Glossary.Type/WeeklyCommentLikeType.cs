...
namespace SKT.Glossary.Type
{
	...
	/// 작성자 : miksystem.com
	/// </summary>
	public class WeeklyCommentLikeType
	{
		#region Constructors
		...
		/// Initializes a new instance of the WeeklyCommentLikeType class.
		/// </summary>
		public WeeklyCommentLikeType(long commentID, string userID, string userName, string userIP, string userMachineName, string likeY, DateTime createDateTime)
		{
		...
		/// Initializes a new instance of the WeeklyCommentLikeType class.
		/// </summary>
		public WeeklyCommentLikeType(long iD, long commentID, string userID, string userName, string userIP, string userMachineName, string likeY, DateTime createDateTime)
		{
			this.ID = iD;
			this.CommentID = commentID;
			this.UserID = userID;
