...
namespace SKT.Glossary.Type
{
	...
	/// 작성자 : miksystem.com
	/// </summary>
	public class WeeklyCommentType
	{
		#region Constructors
		...
		/// Initializes a new instance of the WeeklyCommentType class.
		/// </summary>
		public WeeklyCommentType(long sUP_ID, long weeklyID, string contents, string userID, string userName, string dutyName, string deptName, DateTime createDateTime = new DateTime(), DateTime updateDateTime = new DateTime())
		{
			this.SUP_ID = sUP_ID;
		...
		/// Initializes a new instance of the WeeklyCommentType class.
		/// </summary>
        public WeeklyCommentType(long weeklyCommentID, long sUP_ID, long weeklyID, string contents, string userID, string userName, string dutyName, string deptName, DateTime createDateTime = new DateTime(), DateTime updateDateTime = new DateTime())
		{
