...
{
    public class MonthlyTeamLeaderNotiCheckType
    {
        ...
        /// </summary>
        public MonthlyTeamLeaderNotiCheckType()
        {
        }
        ...
        /// Initializes a new instance of the WeeklyTeamLeaderNotiCheckType class.
        /// </summary>
        public MonthlyTeamLeaderNotiCheckType(string userID, string teamMemberYN, string teamMemberAllYN, string sendYN)
        {
            this.UserID = userID;
        ...
        /// Initializes a new instance of the WeeklyTeamLeaderNotiCheckType class.
        /// </summary>
        public MonthlyTeamLeaderNotiCheckType(int weeklyNotiID, string userID, string teamMemberYN, string teamMemberAllYN, string sendYN)
        {
