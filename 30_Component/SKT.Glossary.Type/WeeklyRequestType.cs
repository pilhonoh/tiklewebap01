...
{
    public class WeeklyRequestType
    {
        #region Constructors
        ...
        /// Initializes a new instance of the WeeklyRequestType class.
        /// </summary>
        public WeeklyRequestType(int year, int yearWeek, string sendUserName, string sendUserID, string sendUserPositionName, string receiveUserName, string receiveUserID, string receiveUserPositionName, string sendYN)
        {
            this.Year = year;
        ...
        /// Initializes a new instance of the WeeklyRequestType class.
        /// </summary>
        public WeeklyRequestType(int weeklyRequestID, int year, int yearWeek, string sendUserName, string sendUserID, string sendUserPositionName, string receiveUserName, string receiveUserID, string receiveUserPositionName, string sendYN)
        {
