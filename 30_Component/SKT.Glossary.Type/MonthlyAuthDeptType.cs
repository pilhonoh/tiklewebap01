...
namespace SKT.Glossary.Type
{
	...
	/// 작성자 : miksystem.com
	/// </summary>
    public class MonthlyAuthDeptType
    {
		#region Constructors
		...
		/// Initializes a new instance of the WeeklyLikeType class.
		/// </summary>
		public MonthlyAuthDeptType(string deptName, string deptCode, string authDeptCode, string topAuthDeptCode)
		{
		...
		/// Initializes a new instance of the WeeklyLikeType class.
		/// </summary>
        public MonthlyAuthDeptType(long weeklyAuthDeptID, string deptName, string deptCode, string authDeptCode, string topAuthDeptCode)
		{
