...
namespace SKT.Glossary.Type
{
	...
	public class MonthlyType
	{
		...
		/// Initializes a new instance of the WeeklyType class.
		/// </summary>
        public MonthlyType(long weeklyID, string contents, string textContents, int viewLevel, string teamChiefYN, string userID, string userName, string userEmail, string deptName, string deptCode, int year, int yearWeek, string tempYN, string memoWriterID, string memoContents, string memoSentYN, string LastUpdateWriterID, int hits = 0, int likeCount = 0, DateTime createDateTime = new DateTime(), DateTime updateDateTime = new DateTime(), DateTime date = new DateTime())
		{
        ...
        //2015.07.13 zz17779
        public MonthlyType(string commonWeeklyFlag, long weeklyID, string contents, string textContents, int viewLevel, string teamChiefYN, string userID, string userName, string userEmail, string deptName, string deptCode, int year, int yearWeek, string tempYN, string memoWriterID, string memoContents, string memoSentYN, string LastUpdateWriterID, int hits = 0, int likeCount = 0, DateTime createDateTime = new DateTime(), DateTime updateDateTime = new DateTime(), DateTime date = new DateTime())
        {
            this.WeeklyID = weeklyID;
            this.TextContents = textContents;
            this.ViewLevel = viewLevel;
        ...
        public string MonthlyYYYY { get; set; }     // VARCHAR(4)
        public string MonthlyMM { get; set; }       // VARCHAR(2)
        public string MonthlyYYYYMM { get; set; }   // VARCHAR(6)
        public string MonthlyPrintText { get; set; }
    ...
    public class MonthlyUserType
    {
        public MonthlyUserType()
        {
        }

        public MonthlyUserType(string userID, string userName, string positionName, long weeklyID, string contents, string textContents, string tempYN, DateTime updateDateTime)
        {
            this.UserID = userID;
            this.UserName = UserName;
    ...
    public class DeptMonthlyType
    {
        ...
        public string DisplayLevel { get; set; } // 겸직용 부서명
    ...
    /// 작성자 : miksystem.com
    /// </summary>
    public class DEPARTMENT_ORGCHARTType_Monthly
    {
        #region Constructors
        ...
        /// </summary>
        public DEPARTMENT_ORGCHARTType_Monthly()
        {
        }
        ...
        /// Initializes a new instance of the DEPARTMENT_ORGCHARTType class.
        /// </summary>
        public DEPARTMENT_ORGCHARTType_Monthly(int iD, DateTime cREATEDATE, DateTime lASTMODIFIEDDATE, string departmentNumber, string department, string displayName, string displayLevel, string displayOrder, bool hasChild, string locationCode, string managerEmployeeID, string upperDepartmentNumber, string displayYN, string mail, string pATH)
        {
            this.ID = iD;
    ...
    public class MonthlyMailType
    {
        ...
        /// Initializes a new instance of the WeeklyMailType class.
        /// </summary>
        public MonthlyMailType(string weeklyID, string messageID, DateTime dateTimeSent)
        {
            this.WeeklyID = weeklyID;
    ...
    public class MonthlyAbsenceType
    {
        public MonthlyAbsenceType(){}

        public MonthlyAbsenceType(int idx, string userID, string absence_UserID, string absence_UserNm, string absence_Comment, string absence_StartDt, string absence_EndDt, string absence_Flag)
        {
            this.Idx = idx;
            this.UserID = userID;
