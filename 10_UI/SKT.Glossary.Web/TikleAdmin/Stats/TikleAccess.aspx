<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GlossaryAdmin.Master" AutoEventWireup="true" CodeBehind="TikleAccess.aspx.cs" Inherits="SKT.Glossary.Web.TikleAdmin.Stats.TikleAccess" %>
...
<div style="margin-top:30px;">
				...
				<table cellpadding="0" cellspacing="0" width="100%" class="TableStyle">
					<tr>
						...
						<td>
                            ...
                            <asp:ImageButton ID="btnStatDeptToExcel" class="btnExcel" ImageUrl="~/Common/images/btn/excel.png" runat="server" OnClientClick="return sarchDate('E');" OnClick="btnStatDeptToExcel_Click" style="float:left; top:0; margin:0;" />
			...
			<table cellpadding="0" cellspacing="0" width="600" class="TableStyle">
                <colgroup>
  				...
  				<tr>
					<th class="tac" rowspan="2"><strong>부서명</strong></th>
                    <th class="tac" rowspan="2"><strong>인원수</strong></th>
                    <th class="tac" colspan="2"><strong>끌.전체</strong></th>
					<th class="tac" colspan="2"><strong>끌.지식</strong></th>
				</tr>
                <tr style="background-color:#fafafa;">
                    <td style="text-align:center;">방문자</td>
                    <td style="text-align:center;">이용횟수</td>
                    <td style="text-align:center;">방문자</td>
                    <td style="text-align:center;">이용횟수</td>
                </tr>
                ...
                <asp:Repeater ID="rptIn" runat="server" >
                    <ItemTemplate>
	                    <tr>
		                    ...
		                    <td class="tac"><%# DataBinder.Eval(Container.DataItem, "UVCNT")%></td>
		                    <td class="tac"><%# DataBinder.Eval(Container.DataItem, "AllCNT")%></td>
                            <td class="tac"><%# DataBinder.Eval(Container.DataItem, "AllCNT_Total")%></td>
                            <td class="tac"><%# DataBinder.Eval(Container.DataItem, "GlossaryCNT")%></td>
                            <td class="tac"><%# DataBinder.Eval(Container.DataItem, "Glossary_Total")%></td>
                ...
                <tr style="background-color:#fafafa;">
		            <td class="tac">합계</td>
		            <td class="tac"><asp:Literal ID="litUserViewCNT" runat="server"></asp:Literal></td>
                    <td class="tac"><asp:Literal ID="litAllCNT" runat="server"></asp:Literal></td>
                    <td class="tac"><asp:Literal ID="litAllTotal" runat="server"></asp:Literal></td>
                    <td class="tac"><asp:Literal ID="litGlossaryCNT" runat="server"></asp:Literal></td>
                    <td class="tac"><asp:Literal ID="litGlossaryTotal" runat="server"></asp:Literal></td>
	            </tr>
			</table>
			</div>
		</dd>
