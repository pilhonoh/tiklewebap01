...
var imgDir = "/common/calendar/images/";	// directory for images ... e.g. var imgDir="/img/"
var calstyle="";
var gotoString = "";
var todayString = "";
var weekString = "";
...
if (dom)
{
    ...
    document.write ("<div id='calendar' style='position:absolute;visibility:hidden;z-index:94;width:220px;height:200px;border:0;'><iframe src='about:blank' width='100%' height='100%'></iframe><div style='position:absolute;left:0px;top:0px;z-index:95' class='ui-calendar-module'><table width="+((showWeekNumber==1)?248:218)+" ><tr bgcolor='#ffffff'><td><table width='"+((showWeekNumber==1)?248:218)+"'><tr><td style='padding:2px;font-family:arial; font-size:11px;'><font color='#ffffff'><B><span id='caption' ></span></B></font></td><td align=right></td></tr></table></td><td id='hid1'><table width='"+((showWeekNumber==1)?248:218)+"' ><tr><td style='padding:2px;font-family:arial; font-size:11px;'><font color='#ffffff'><B><span id='caption2'></span></B></font></td><td  align=right></td></tr></table></td></tr><tr><td  height=\"130px\" style='padding:0px;vertical-align:top;'><span id='content' ></span></td><td id='hid2' style='padding:0px;vertical-align:top;' bgcolor=#ffffff height=\"130\"><span id='content2'  ></span></td></tr>");
    ...
    document.write ("</table></div></div><div id='selectMonth' style='position:absolute;visibility:hidden;z-index:96;width:72px;height=190px;' ><iframe src='about:blank' width='100%' height='100%' frameborder=0></iframe><div id='selectMonth2' style='position:absolute;left:0px;top:0px;z-index:97' ></div></div><div id='selectYear' style='position:absolute;visibility:hidden;z-index:96'></div><div id='selectMonth22' style='position:absolute;left:2px;top:2px;z-index:98'></div></div><div id='selectYear2' style='position:absolute;visibility:hidden;z-index:97'></div>");		
...
function ViewCalendar(ctl, ctl2, ctl3, format,  Flg, offsetx, offsety){
//function ViewCalendar(ctl, ctl2, format, act, Flg, offsetx, offsety){
    ...
    popUpCalendar(offsetx, offsety, ctl, ctl2, ctl3,  format,'');
