...
{
    public partial class GlossaryNewsList_Tnet : System.Web.UI.Page
    {
        int currentPageIndx;
        ...
        private void BindSelect()
        {
            ...
            Titlelist = biz.TotalActivity_Tnet(u.UserID, pager.PageSize, "New", out iTotalCount, null, TagTitle, SearchSort, pager.CurrentIndex, GatheringYN, GatheringID);
        ...
        protected void rptInGeneral_OnItemDataBound(Object Sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                // 권한 아이콘
                if (((GlossaryType)e.Item.DataItem).Permissions.Equals("SomePublic"))
                {
                    if (GatheringYN != "Y")
                    {
