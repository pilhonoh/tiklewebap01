<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DirectoryManagerIframe.aspx.cs" Inherits="SKT.Glossary.Web.Directory.DirectoryManagerIframe"  %>
...
<html lang="ko">
	<head>
		...
		<script type="text/javascript">
		    ...
		    $(document).ready(function () {
		        ...
		        $('#<%= this.hdDirectoryID.ClientID %>').val(commonID);
			    ...
			    try {
			        $.ajax({
			            ...
			            data: "{commonID : '" + commonID + "',tkType : 'directory'}",
			            dataType: "json",
			            async: false,
			...
			function fnSave() {
			   ...
			   <%-- var dir = "<%= DivID %>";
                ...
                //인원 모음
			    var arrUserID = $("#UserControl_hdUserItemID").val();
			    alert(arrUserID);
			    try {
			        $.ajax({
			            type: "POST",
			            contentType: "application/json; charset=utf-8",
			            url: "/Common/Controls/AjaxControl.aspx/GetDirectoryManagerCheck",
			            data: "{dirID : '" + dir + "', arrUserID : '" + arrUserID + "'}",
			            dataType: "json",
			            async: false,
			            success: function (data) {
			                //alert(data.d);
	...
	<body onkeydown = "return (event.keyCode!=13)">
		<form name="aspnetForm" method="post" runat="server" action="DirectoryManagerIframe.aspx" id="aspnetForm">
			<!--CONTENTS-->
            <div class="pop">
	            <!--문서_폴더관리-->
